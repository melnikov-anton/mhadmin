                ...
                <div class="col-md-6 p-4 m-4">
                    ...
                    <div class="row">
                        <div class="col-md-8 mx-auto border border-primary rounded-lg p-4">
                          <form action="/user/changepassword/<?php echo $user->getUserId(); ?>" id="ch_pass" method="post" onSubmit='return checkPass("ch_pass", "npw", "rnpw", "msg2")'>
                                ...
                                <div class="col-md-12 mx-auto" style="min-height: 1.5em;">
                                  <h5 id="msg2" class="text-center text-danger"><h5>
                                </div>
